...
pszWindowClass       db 'InvadersClassWindow', 0
pszWindowTitle       db 'Space Invaders', 0

pszMsgCpt       db 'Space Invaders', 0
...
.ENDPROLOG 
  ...
  MOV WINMAIN_FRAME.InitializationStruct.DisableEscapeExit[RSP], 1
