...
extern Coderotting_Init:proc
extern Coderotting_Demo:proc
extern Coderotting_Free:proc
...
GlobalDemoStructure  dq Coderotting_Init
                     dq Coderotting_Demo
                     dq Coderotting_Free
;
; End Tag
...
pszWindowClass       db 'CodeRottingClassWindow', 0
pszWindowTitle       db 'Coderotting', 0

pszMsgCpt       db 'Coderotting', 0
