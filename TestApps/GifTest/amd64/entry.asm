...
extern Gif_Init:proc
extern Gif_Demo:proc
extern Gif_Free:proc
...
GlobalDemoStructure  dq Gif_Init 
                     dq Gif_Demo
                     dq Gif_Free
;
; End Tag
...
pszWindowClass       db 'GifClassWindow', 0
pszWindowTitle       db 'Gif Demo', 0

pszMsgCpt       db 'Gif Demo', 0
