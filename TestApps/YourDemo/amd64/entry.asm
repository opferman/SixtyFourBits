...
GlobalDemoStructure  dq YourDemo_Init 
                     dq YourDemo_Demo
                     dq YourDemo_Free
;
; End Tag
...
pszWindowClass       db 'YourDemoClassWindow', 0
pszWindowTitle       db 'YourDemo Demo', 0

pszMsgCpt       db 'YourDemo Demo', 0
