...
extern GifRt_Init:proc
extern GifRt_Demo:proc
extern GifRt_Free:proc
...
GlobalDemoStructure  dq GifRt_Init 
                     dq GifRt_Demo
                     dq GifRt_Free
;
; End Tag
...
pszWindowClass       db 'GifRtClassWindow', 0
pszWindowTitle       db 'Gif Real Time Demo', 0

pszMsgCpt       db 'Gif Real Time Demo', 0
