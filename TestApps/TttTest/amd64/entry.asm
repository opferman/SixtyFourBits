...
GlobalDemoStructure  dq TTT_Init 
                     dq TTT_Demo
                     dq TTT_Free
;
; End Tag
...
pszWindowClass       db 'TttClassWindow', 0
pszWindowTitle       db 'Tic Tac Toe Demo', 0

pszMsgCpt       db 'Tic Tac Toe Demo', 0
