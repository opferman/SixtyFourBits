...
extern GifRot_Init:proc
extern GifRot_Demo:proc
extern GifRot_Free:proc
...
GlobalDemoStructure  dq GifRot_Init 
                     dq GifRot_Demo
                     dq GifRot_Free
;
; End Tag
...
pszWindowClass       db 'GifRotClassWindow', 0
pszWindowTitle       db 'Gif Rot Demo', 0

pszMsgCpt       db 'Gif Rot Demo', 0
