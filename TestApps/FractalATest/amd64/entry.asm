...
GlobalDemoStructure  dq FractalA_Init 
                     dq FractalA_Demo
                     dq FractalA_Free
;
; End Tag
...
pszWindowClass       db 'YourFractalAClassWindow', 0
pszWindowTitle       db 'Fractal A Demo', 0
